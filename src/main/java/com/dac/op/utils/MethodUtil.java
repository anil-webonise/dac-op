package com.dac.op.utils;

import com.dac.op.constants.CommonConstants;
import com.dac.op.modules.exceptions.GlobalException;
...
@Component
@ComponentScan(basePackages = {CommonConstants.adminControllerBasePackage})
    ...
    public void save(T entity) throws Throwable {
        ...
        try {
            ...
            if (session != null) {
                ...
                throw new GlobalException(CommonConstants.errorMsg + CommonConstants.savingData + CommonConstants.constactSupportTeamMsg);
            }
        } catch (Exception e) {
            entityManager.getTransaction().rollback();
            log.error(CommonConstants.errorMsg + CommonConstants.savingData, e);
            throw new GlobalException(CommonConstants.errorMsg + CommonConstants.savingData + CommonConstants.constactSupportTeamMsg);
        } finally {
            if (session != null) {
                session.close();
    ...
    public void delete(String tableName, Long id) throws Throwable {
        ...
        try {
            ...
            if (session != null) {
                ...
                throw new GlobalException(CommonConstants.errorMsg + CommonConstants.deletingData + CommonConstants.constactSupportTeamMsg);
            }
        } catch (Exception e) {
            e.printStackTrace();
            entityManager.getTransaction().rollback();
            log.error(CommonConstants.errorMsg + CommonConstants.deletingData, e);
            throw new GlobalException(CommonConstants.errorMsg + CommonConstants.deletingData + CommonConstants.constactSupportTeamMsg);
        } finally {
            if (session != null) {
                // session.flush();
